...
} from "@/common/resources/resource_types";
...
export const resourceLoader = new ResourceLoader(stagedResources);
export const audioSystem = new AudioSystem(resourceLoader, audioPacks);
export const imageSystem = new ImageSystem(resourceLoader);
